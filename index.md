...
50% of decentralized apps are DEX that have no liquidity and transact useless tokens, 25% are silly games such as cryptokitties and 20% are Ponzi pyramid schemes. So get the real facts on the junky "use cases" of Ethereum and stop living in your bubble. Can't bullshit me as I know my facts.
...
Read my Project Syndicate oped on why tokens are non-compliant scams
and why only reason to issue tokens can be to form an illegal cartel to gouge consumers.
Study your Economics 101 before spewing this silly nonsense on every biz needing its own currency.
